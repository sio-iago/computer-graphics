...
static void drawBook(int frednumber, std::string *names, int stackPosition){
    ...
    GLint bookStackCoordinates[4][2] = {
        {4,6},
        {4,7},
        {4+booksize,7},
        {4+booksize,6}
    ...
    for(int j=0; j<frednumber; j++)
    {
        ...
        {
            glVertex2i(
                       (bookStackCoordinates[i][0]+1+(booksize*stackPosition))*scale ,
                       (bookStackCoordinates[i][1]+j)*scale
                       );
        }
    ...
    for(int j=0; j<frednumber; j++)
    {
        ...
        GLint xRaster = (4.2+1+stackPosition*booksize) * scale;
        GLint yRaster = (6.5+j) * scale;
